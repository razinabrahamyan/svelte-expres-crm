<script lang="ts">
	...
	let WHOLE_WIDTH = 400, WHOLE_HEIGHT = 225;
	let MOUSEDOWN_CORNER = false;
	let MOUSEDOWN_WHOLE = false;
	let CHANGE_LEFT = false, CHANGE_RIGHT = false, CHANGE_TOP = false, CHANGE_BOTTOM = false;
	let MOUSE_START_LEFT  = 0, MOUSE_START_TOP = 0;
	...
	$: {
		rotateDetails.scale = (WHOLE_HEIGHT * Math.abs(Math.sin((90 - rotate) * (Math.PI/180))) + WHOLE_WIDTH * Math.abs(Math.cos((90-rotate) * (Math.PI/180)))) / WHOLE_HEIGHT
	...
	<div class="container text-black">
			...
			<div style="padding: 120px 50px; display: flex; gap: 20px;">
				<div style="position: relative;" id="image_handler">
					{#each blurs as item, index }
						<div>
							<div class="absolute blur_handler z-10 backdrop-blur activeBlur"
							...
							>
								<div class="corner c_1" on:mousedown={handleBlurMouseDown} data="1" data_key={index} data-left="1" data-top="1"></div>
								<div class="corner c_2" on:mousedown={handleBlurMouseDown} data="2" data_key={index} data-top="1" data-right="1"></div>
								<div class="corner c_3" on:mousedown={handleBlurMouseDown} data="3" data_key={index} data-right="1" data-bottom="1"></div>
								<div class="corner c_4" on:mousedown={handleBlurMouseDown} data="4" data_key={index} data-bottom="1" data-left="1"></div>
							</div>
						</div>
					{/each}
					{#if cropping}
					<div class="crop_window_handler"
						...
						<div class="shadow_handler">
							...
							<div class="shadow s_3"></div>
							<div class="shadow s_4"></div>
						</div>
						<div class="lines_handler">
							<div class="line l_1"></div>
							<div class="line l_2"></div>
							<div class="line l_3"></div>
							<div class="line l_4"></div>
						</div>
						<div class="corners_handler">
							<div class="corner c_1" data-left="1" data-top="1"></div>
							<div class="corner c_2" data-top="1" data-right="1"></div>
							<div class="corner c_3" data-right="1" data-bottom="1"></div>
							<div class="corner c_4" data-bottom="1" data-left="1"></div>
						</div>
						<div class="inner"></div>
					</div>
					{/if}
		...
		{/if}
		<button on:click={openCrop} class="btn btn-primary text-white p-0.5"> <Icon icon="material-symbols:crop" width="24" /> </button>
